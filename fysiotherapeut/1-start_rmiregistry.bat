...
rmiregistry -J-Djava.rmi.server.codebase="http://localhost/classes/physio-server.jar http://localhost/classes/physio-shared.jar http://localhost/classes/physio-api.jar http://localhost/classes/insurerer_shared.jar http://localhost/classes/SharedPhysioInsurance-1.0-SNAPSHOT.jar http://localhost/classes/insurerer_server.jar"
