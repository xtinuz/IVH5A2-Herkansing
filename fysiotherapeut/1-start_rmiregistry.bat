...
rmiregistry -J-Djava.rmi.server.codebase="http://localhost/classes/physio-server.jar http://localhost/classes/physio-shared.jar http://localhost/classes/physio-api.jar"
